load('result_smoother2');

subplot(2, 2, 1);
errorbar(mus_f(1, :), sigs_f(1, :)); hold on;
errorbar(mus_b(1, :), sigs_b(1, :)); hold on;
errorbar(mus_fb(1, :), sigs_fb(1, :)); hold on;
xlabel('Time');
ylabel('x');
legend('Filter', 'Backward', 'Forward-Backward');
hold off;

subplot(2, 2, 2);
errorbar(mus_f(2, :), sigs_f(2, :)); hold on;
errorbar(mus_b(2, :), sigs_b(2, :)); hold on;
...
errorbar(mus_b(3, :), sigs_b(3, :)); hold on;
...
errorbar(mus_b(4, :), sigs_b(4, :)); hold on;
